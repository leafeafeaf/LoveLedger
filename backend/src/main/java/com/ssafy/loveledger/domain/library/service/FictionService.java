...
public class FictionService {
    ...
    public FictionArtReadRes getFictionArtAI(FictionArtCreateReq fictionArtCreateReq) {
        ...
        String prompt = """
            ...
            - 무조건 url에 항상 seed값을 넣어줘 seed 값은 항상 11 ex: https://image.pollinations.ai/prompt/?seed=11
            ...
            10. url에 항상 seed값을 넣어줘 seed 값은 항상 11 ex: https://image.pollinations.ai/prompt/?seed=11
