...
def upload_embeddings_to_elasticsearch(
        file_path: str,
        index_name: str,
        elasticsearch_url: str = "http://j12b205.p.ssafy.io:9200",
        batch_size: int = 20,
...
if __name__ == "__main__":
    # 설정
    file_path = "fastapi/mimmim_embeding.json"  # 임베딩 데이터 파일
    index_name = "loveledger_dense"  # Elasticsearch 인덱스 이름
    elasticsearch_url = "http://j12b205.p.ssafy.io:9200"  # Elasticsearch URL
