  ...
  const themes: ThemeItem[] = [
    {
      ...
      label: "일상",
      icon: "palette",
      image: require("../../../assets/images/theme/daily.png"),
    },
    {
      id: 2,
      label: "판타지",
      icon: "palette",
      image: require("../../../assets/images/theme/fantasy.png"),
    },
    {
      id: 3,
      label: "파파라치",
      icon: "palette",
      image: require("../../../assets/images/theme/paparazzi.png"),
    },
    {
      id: 4,
      label: "뉴스",
      icon: "palette",
      image: require("../../../assets/images/theme/news.png"),
    },
    {
      id: 5,
      label: "유행어",
