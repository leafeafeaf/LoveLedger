  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Modify transaction details</Text>
      </View>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setEditedTransaction(prev => ({ ...prev, targetname: text }))}
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setEditedTransaction(prev => ({ ...prev, amount: parseInt(text) || 0 }))}
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setEditedTransaction(prev => ({ ...prev, category: text }))}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.typeSelector}>
            <Pressable
              ...
              onPress={() => setEditedTransaction(prev => ({ ...prev, remittance: false }))}
            >
              <MaterialCommunityIcons 
                name="bank-plus" 
                size={24} 
                color={!editedTransaction.remittance ? theme.colors.white : theme.colors.primary} 
              />
              <Text style={[
                styles.typeText,
            ...
            <Pressable
              ...
              onPress={() => setEditedTransaction(prev => ({ ...prev, remittance: true }))}
            >
              <MaterialCommunityIcons 
                name="bank-minus" 
                size={24} 
        ...
        <View style={styles.section}>
          ...
          <TextInput
            style={styles.input}
            value={editedTransaction.time.split('T')[1].substring(0, 5)}
            onChangeText={(text) => {
              const [hours, minutes] = text.split(':');
              const newTime = editedTransaction.time.split('T')[0] + `T${hours || '00'}:${minutes || '00'}:00`;
