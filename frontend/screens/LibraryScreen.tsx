...
export default function LibraryScreen({ navigation }) {
  ...
  const mockDiaries = [
    { id: 1, title: 'Our First Date', date: '2024-03-13', type: 'diary', mood: 'happy' },
    { id: 2, title: 'Weekend Getaway', date: '2024-03-12', type: 'diary', mood: 'excited' },
    { id: 3, title: 'Coffee Shop Meeting', date: '2024-03-11', type: 'diary', mood: 'peaceful' },
  ];

  const mockStories = [
    { id: 1, title: 'Our Love Story', date: '2024-03-13', type: 'story', theme: 'romance' },
    { id: 2, title: 'Future Dreams', date: '2024-03-10', type: 'story', theme: 'fantasy' },
  ];
