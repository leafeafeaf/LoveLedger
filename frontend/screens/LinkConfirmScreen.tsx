...
export default function LinkConfirmScreen({ navigation, route }) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          아래 사용자가 귀하와 부부 연동을 요청했습니다.
          연동을 수락하시면 서로의 재정 정보와 기록을 공유하게 됩니다.
        </Text>
        ...
        <View style={styles.partnerCard}>
          ...
          <Text style={styles.partnerDate}>가입일: {partnerInfo.joinDate}</Text>
          {partnerInfo.message && (
        ...
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningText}>
            연동은 양측의 동의가 있어야만 가능하며, 한 번 연동하면 관리자에게 문의하지 않는 한 해제할 수 없습니다.
          </Text>
        </View>
      </View>
