...
export default function ProfileEditScreen({ navigation, route }) {
  ...
  const handlePhotoSelect = () => {
    ...
    const mockPhotoUrl = `https://api.a0.dev/assets/image?text=profile%20photo%20of%20${encodeURIComponent(formData.name)}%20portrait&seed=${Math.random()}`; 
          ...
          <View style={styles.photoContainer}>
            {formData.photo ? (
              ...
              <View style={styles.photoPlaceholder}>
                <MaterialCommunityIcons name="account" size={60} color={theme.colors.textLight} />
              </View>
            )}
          </View>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData(prev => ({ ...prev, motto: text }))}
