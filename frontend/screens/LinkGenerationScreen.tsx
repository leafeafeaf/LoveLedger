...
export default function LinkGenerationScreen({ navigation }) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.iconContainer}>
          <MaterialCommunityIcons name="heart-multiple" size={60} color={theme.colors.primary} />
        </View>
        
        <Text style={styles.title}>부부 연동하기</Text>
        <Text style={styles.description}>
          부부 연동을 통해 배우자와 함께 재정을 관리하고 추억을 공유하세요.
          아래 버튼을 눌러 초대 링크를 생성한 후, 배우자에게 공유해 주세요.
        </Text>
        ...
        {!generatedLink ? (
          ...
          >
            {isGenerating ? (
              ...
              <>
                <MaterialCommunityIcons name="link-variant" size={24} color={theme.colors.white} />
          ...
          <View style={styles.linkContainer}>
            ...
            <View style={styles.actionButtons}>
              ...
              >
                <MaterialCommunityIcons name="share-variant" size={20} color={theme.colors.white} />
      ...
      <View style={styles.infoSection}>
        ...
        <View style={styles.infoItem}>
          ...
          <Text style={styles.infoText}>생성된 링크는 24시간 동안만 유효합니다.</Text>
        </View>
        <View style={styles.infoItem}>
          <MaterialCommunityIcons name="information" size={20} color={theme.colors.primary} />
        ...
        <View style={styles.infoItem}>
          <MaterialCommunityIcons name="information" size={20} color={theme.colors.primary} />
          <Text style={styles.infoText}>연동 후에는 상대방의 동의 없이 해제할 수 없습니다.</Text>
        </View>
      </View>
    </View>
  );
