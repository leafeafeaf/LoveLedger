...
export default function StoryGenerationScreen({ navigation, route }) {
  ...
  const getStatusMessage = () => {
    const progressValue = loadingProgress._value || 0;
    if (progressValue < 30) {
    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.progressHint}>
          Creating a {settings.themeStyle} story based on your {settings.period} history
        </Text>
      </View>
    </View>
  );
