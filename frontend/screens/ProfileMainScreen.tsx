...
export default function ProfileMainScreen({ navigation }) {
  ...
  const menuOptions = [
    { id: 'editProfile', label: '개인 정보 수정', icon: 'account-edit', screen: 'ProfileEdit' },
    { id: 'goals', label: '목표 관리', icon: 'flag-checkered', screen: 'GoalList' },
    { id: 'settings', label: '앱 설정', icon: 'cog', screen: 'Settings' },
    { id: 'help', label: '도움말 및 지원', icon: 'help-circle', screen: 'Help' },
  ];
        ...
        <View style={styles.profileHeader}>
          <View style={styles.coverImageContainer}>
            ...
            <Pressable style={styles.editCoverButton}>
              <MaterialCommunityIcons name="image-edit" size={20} color={theme.colors.white} />
            </Pressable>
          </View>
          ...
          <View style={styles.statsContainer}>
            <View style={styles.statItem}>
              ...
              <Text style={styles.statValue}>{profileData.couple.meetDays}</Text>
              <Text style={styles.statLabel}>함께한 일수</Text>
            </View>
            <View style={styles.statDivider} />
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="notebook" size={24} color={theme.colors.primary} />
              <Text style={styles.statValue}>{profileData.couple.diariesCount}</Text>
              <Text style={styles.statLabel}>일기</Text>
            </View>
            <View style={styles.statDivider} />
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="book-open-variant" size={24} color={theme.colors.primary} />
              <Text style={styles.statValue}>{profileData.couple.storiesCount}</Text>
        ...
        <View style={styles.partnerSection}>
          ...
          <View style={styles.partnerCardsContainer}>
            <Pressable 
              ...
              onPress={() => navigation.navigate('ProfileEdit', { partner: 'partner1' })}
            >
              <View style={styles.partnerPhotoContainer}>
                {profileData.partner1.photo ? (
                  ...
                  <View style={[styles.partnerPhotoPlaceholder, { backgroundColor: theme.colors.primary }]}>
                    <MaterialCommunityIcons name="account" size={40} color={theme.colors.white} />
                  </View>
                )}
              ...
              <Text style={styles.partnerName}>{profileData.partner1.name}</Text>
              <Text style={styles.partnerAge}>{profileData.partner1.age}세</Text>
              <Text style={styles.partnerMotto}>"{profileData.partner1.motto}"</Text>
            </Pressable>

            <Pressable 
              style={styles.partnerCard}
              onPress={() => navigation.navigate('ProfileEdit', { partner: 'partner2' })}
            >
              <View style={styles.partnerPhotoContainer}>
                {profileData.partner2.photo ? (
                  ...
                  <View style={[styles.partnerPhotoPlaceholder, { backgroundColor: theme.colors.accent }]}>
                    <MaterialCommunityIcons name="account" size={40} color={theme.colors.white} />
                  </View>
                )}
                <View style={styles.partnerEditBadge}>
              ...
              <Text style={styles.partnerName}>{profileData.partner2.name}</Text>
              <Text style={styles.partnerAge}>{profileData.partner2.age}세</Text>
              <Text style={styles.partnerMotto}>"{profileData.partner2.motto}"</Text>
            </Pressable>
          </View>
        </View>        <View style={styles.menuSection}>
          ...
          >
            <View style={[styles.menuIconContainer, { backgroundColor: `${theme.colors.primary}30` }]}>
              <MaterialCommunityIcons name="heart-multiple" size={24} color={theme.colors.primary} />
            </View>
            ...
            onPress={() => {
              Alert.alert(
                ...
                [
                  ...
                  { text: '삭제', style: 'destructive', onPress: () => navigation.navigate('Login') }
                ]
              );
            }}
          >
