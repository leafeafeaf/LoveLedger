package com.ssafy.mvcservice.domain.history.domain.repository;
...
public interface HistoryRepository extends JpaRepository<History, String> {
    ...
    @Query(
        "SELECT NEW com.ssafy.mvcservice.domain.account.presentation.dto.response.MonthlyStatisticsResponse( "
            + "   d.category , " +
