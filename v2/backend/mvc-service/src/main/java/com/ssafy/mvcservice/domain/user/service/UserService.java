package com.ssafy.mvcservice.domain.user.service;


import com.ssafy.mvcservice.domain.couple.domain.Couple;
import com.ssafy.mvcservice.domain.couple.domain.repository.CoupleRepository;
...
public class UserService {
    ...
    private DetailUserResponse.CoupleInfo getCoupleInfo(Long userId) {
        ...
        Long partnerId =
            userId.equals(couple.getHusbandId()) ? couple.getWifeId() : couple.getHusbandId();

        User partner = userRepository.findById(partnerId)
            .orElseThrow(
                () -> new LoveLedgerException(ErrorCode.USER_NOT_FOUND, String.valueOf(partnerId)));
        ...
        return DetailUserResponse.CoupleInfo.builder()
            ...
            .darlingBirthDay(
                partner.getBirthDay() != null ? partner.getBirthDay().format(DATE_FORMATTER) : null)
