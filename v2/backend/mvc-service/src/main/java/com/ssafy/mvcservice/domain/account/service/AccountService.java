package com.ssafy.mvcservice.domain.account.service;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ssafy.mvcservice.domain.account.domain.Account;
import com.ssafy.mvcservice.domain.account.domain.repository.AccountRepository;
import com.ssafy.mvcservice.domain.account.presentation.dto.request.AccountAuthenticationRequest;
import com.ssafy.mvcservice.domain.account.presentation.dto.request.AccountHistoryDetailRequest;
import com.ssafy.mvcservice.domain.account.presentation.dto.request.CategoryPrescriptionRequest;
import com.ssafy.mvcservice.domain.account.presentation.dto.request.MemberInfoRequest;
import com.ssafy.mvcservice.domain.account.presentation.dto.request.SSAFYRequestHeader;
import com.ssafy.mvcservice.domain.account.presentation.dto.response.CategoryPrescriptionResponse;
...
import com.ssafy.mvcservice.domain.account.presentation.dto.response.HistoryResponse;
import com.ssafy.mvcservice.domain.account.presentation.dto.response.MemberInfoResponse;
import com.ssafy.mvcservice.domain.account.presentation.dto.response.MonthlyStatisticsResponse;
import com.ssafy.mvcservice.domain.account.presentation.dto.response.SSAFYResponse;
...
import com.ssafy.mvcservice.domain.statistics.domain.repository.DailyStatisticsRepository;
...
import com.ssafy.mvcservice.global.util.CategoryPrescriptionUtil;
import com.ssafy.mvcservice.global.util.OpenFeignUtil;
...
public class AccountService {
    ...
    public void getVerificationCode(User user, String accountNo) {
        ...
        try {
            ...
            log.info(response.getResultData().toString());
        } catch (Exception e) {
    ...
    public void doVerification(User user, String accountNo, String authCode) {
        ...
        SSAFYResponse response;

        try {
            response = openFeignUtil.getAccountAuthentication(request);
        } catch (Exception e) {
