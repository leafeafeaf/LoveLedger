...
import com.ssafy.mvcservice.domain.library.presentation.dto.request.diary.DiaryCreateRequest;
import com.ssafy.mvcservice.domain.library.presentation.dto.request.diary.DiaryUpdateRequest;
import com.ssafy.mvcservice.domain.library.presentation.dto.request.diary.UpdateHistoryRequest;
import com.ssafy.mvcservice.domain.library.presentation.dto.response.diary.DiaryReadAllResponse;
import com.ssafy.mvcservice.domain.library.presentation.dto.response.diary.DiaryReadResponse;
import com.ssafy.mvcservice.domain.library.service.DiaryService;
...
public class DiaryController {
    ...
    @GetMapping("/{diaryId}")
    public DiaryReadResponse readDiary(@PathVariable long diaryId, HttpServletRequest request) {
        User user = userUtil.getCurrentUser(request);
